...
<?php
$page = 'case';
$title = 'Панорама парк 70кв.м';
$description = 'Наш проект Панорама парк 70кв.м';
...
<main>
            ...
            <div class="main_container">
                <div class="main_container-features dark-grey-bg">
                    ...
                    <div class="main_features">
                        <p>Нашей командой был разработан<br>дизайн-проект и&nbsp;выполнен ремонт<br> для молодой девушки в&nbsp;двухкомнатной квартире в&nbsp;пастельных тонах.</p>
                    </div>
                </div>
                <div class="main_container-stats dark-grey-bg">
                    ...
                    <div class="main_stat">
                        <div class="main_stat-container">
                            ...
                            <p class="main_title-h3">ЖК «Панорама парк»</p>
                        </div>
    ...
    <section class="casedesk_section">
        <div class="container">
            <div class="casedesk_container">
                ...
                <p class="casedesk_desk">Нашей компанией был выполнен ремонт двухкомнатной квартиры в&nbsp;ЖК&nbsp;&laquo;Панорама парк&raquo; для молодой девушки. Большая и&nbsp;просторная квартира была выполнена в&nbsp;светлых тонах по&nbsp;дизайн-проекту, разработанному нашей компанией. Изюминкой данного проекта являются двери в&nbsp;потолок, под которые наша команда целенаправленно увеличивала проёмы.</p>
                <div class="casedesk_container-img">
                    <img src="../images/panorama70_casedesk_desk-1.jpg" alt="" class="casedesk_img casedesk_img1">
                    <img src="../images/panorama70_casedesk_desk-2.jpg" alt="" class="casedesk_img casedesk_img2">
                </div>
            </div>
        </div>
    </section>
                ...
                <ol class="process_container-stages">
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">Мы&nbsp;начали создание дизайн-проекта квартиры площадью 70&nbsp;м&sup2; с&nbsp;детального обсуждения образа жизни и&nbsp;предпочтений заказчицы. Затем разработали концепцию, учитывающую ее&nbsp;привычки: просторная кухня-гостиная для встреч с&nbsp;друзьями, функциональная спальня с&nbsp;пространством для рисования.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">Мы&nbsp;начали проект с&nbsp;тщательной подготовки и&nbsp;планирования. Провели несколько встреч с&nbsp;нашей заказчицей, составили детальный план работ и&nbsp;бюджет, чтобы клиентка могла быть уверена в&nbsp;прозрачности и&nbsp;эффективности нашего подхода.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">В&nbsp;рамках демонтажных работ мы&nbsp;сносили старые перегородки и&nbsp;формировали проёмы для установки новых дверей скрытого монтажа, учитывая технические требования и&nbsp;эстетический аспект.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">На&nbsp;этапе черновых работ было выполнено оштукатуривание стен под маяк, проведены черновые электромонтажные и&nbsp;сантехнические работы, а&nbsp;также выравнивание пола под напольное покрытие.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">После завершения черновых работ мы&nbsp;выполнили чистовые отделочные работы, а&nbsp;именно: монтаж гипрочного потолка, подготовку стен и&nbsp;нанесение декоративной штукатурки, укладку паркетной доски. В&nbsp;санузлах уложили широкоформатный керамогранит.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">После завершения всех отделочных работ на&nbsp;объекте, нашими специалистами была установлена кухня и&nbsp;мебель под заказ. Также был организован профессиональный клининг!</p>
                        </div>
                    </li>
                </ol>
            </div>
        ...
        <div class="container">
            <div class="result_container">
                ...
                <div class="result_container-img">
                    <img src="../images/panorama70_casedesk_desk-1.jpg" alt="" class="result_img">
                    <img src="../images/panorama70_casedesk_desk-2.jpg" alt="" class="result_img">
                    <img src="../images/panorama70_result_desk-3.jpg" alt="" class="result_img">
                    <img src="../images/panorama70_result_desk-4.jpg" alt="" class="result_img">
                    <img src="../images/panorama70_result_desk-5.jpg" alt="" class="result_img">
                    <img src="../images/panorama70_result_desk-6.jpg" alt="" class="result_img">
                    <img src="../images/panorama70_result_desk-7.jpg" alt="" class="result_img">
                    <img src="../images/panorama70_result_desk-8.jpg" alt="" class="result_img">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="depro_section">
        <div class="container">
            <div class="depro_container">
                <h2 class="title depro_title">Особенности проекта</h2>
                <p class="depro_desk">Изюминкой данного проекта являются двери в&nbsp;потолок, под которые мы&nbsp;целенаправленно увеличивали проёмы.<br><br>
                    Потолки на&nbsp;данном объекте были выполнены из&nbsp;ГКЛ с&nbsp;подготовкой под покраску и&nbsp;дальнейшей покраской, стены были подготовлены под декоративную штукатурку с&nbsp;дальнейшим нанесением материала. На&nbsp;пол уложена паркетная доска. По&nbsp;всей квартире произведена полная замена электрики.<br><br>
                    В&nbsp;санузлах сделана коллекторная сборка, уложен крупноформатный керамогранит, установлена ванна, гигиенический душ и&nbsp;инсталляция.
                </p>
                <div class="depro_container-img">
                    <img src="../images/panorama70_depro.jpg" alt="" class="depro_img">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="bed_container">
                ...
                <div class="bed_img-container">
                    <img src="../images/panorama70_bed1.jpg" alt="" class="bed_img bed_img1">
                    <img src="../images/panorama70_bed2.jpg" alt="" class="bed_img bed_img2">
                    <img src="../images/panorama70_bed3.jpg" alt="" class="bed_img bed_img3">
                    <img src="../images/panorama70_bed4.jpg" alt="" class="bed_img bed_img4">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="kit_container">
                ...
                <div class="kit_container-img">
                    <img src="../images/panorama70_kit1.jpg" alt="" class="kit_img">
                    <img src="../images/panorama70_kit2.jpg" alt="" class="kit_img">
                </div>
            </div>
        </div>
    </section>
    ...
    <style>
        @media (max-width: 980px) {
            .kit_section .kit_container-img .kit_img:nth-child(2) {
                height: 486px;
                object-fit: cover;
            }
        }
    ...
    <section class="san_section">
        <div class="container">
            <div class="san_container">
                <h2 class="title san_title">Санузлы</h2>
                <div class="san_img-container">
                    <img src="../images/panorama70_san1.jpg" alt="" class="san_img san_img1">
                    <img src="../images/panorama70_san2.jpg" alt="" class="san_img san_img2">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="smet_section">
        <div class="container light-grey-bg">
            <h2 class="title smet_title">Сэкономили 535 499₽<br>на чистовых и черновых материалах</h2>
