...
<?php
$page = 'case';
$title = 'Галактика 38кв.м';
$description = 'Наш проект Галактика 38кв.м';
...
<main>
            ...
            <div class="main_container">
                <div class="main_container-features dark-grey-bg">
                    ...
                    <div class="main_features">
                        <p>Нашей командой был разработан дизайн-проект<br>
                            и&nbsp;выполнен ремонт для молодой семьи<br>
                            в&nbsp;современном стиле.</p>
                    </div>
                </div>
                <div class="main_container-stats dark-grey-bg">
                    ...
                    <div class="main_stat">
                        <div class="main_stat-container">
                            ...
                            <p class="main_title-h3">ЖК «Галактика»</p>
                        </div>
                        <img src="../images/location.png" alt="" class="main_stat-img">
                    </div>
                </div>
                <div class="main_video-container">
                    <video src="videos/Zk-Galaxy-38.mp4" class="main_video" autoplay muted loop aria-label="Видеопрезентация интерьера.">Ваш браузер не поддерживает видео.</video>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="casedesk_section">
        <div class="container">
            <div class="casedesk_container">
                <h2 class="title casedesk_title">Функциональная и комфортная квартира</h2>
                <p class="casedesk_desk">Нашей компанией был выполнен ремонт однокомнатной квартиры в&nbsp;ЖК&nbsp;&laquo;Галактика&raquo;.
                    Мы&nbsp;начали сотрудничество с&nbsp;создания дизайн-проекта квартиры 38м&sup2;.<br><br>
                    Наш дизайнер смог функционально использовать небольшую площадь квартиры
                    для комфортного проживания.<br><br>
                    Над данным проектом наша команда работала 1,5&nbsp;месяца, продумывая всё до&nbsp;деталей.</p>
                <div class="casedesk_container-img">
                    <img src="../images/galaxy_casedesk_desk-1.jpg" alt="" class="casedesk_img casedesk_img1">
                    <img src="../images/galaxy_casedesk_desk-2.jpg" alt="" class="casedesk_img casedesk_img2">
                </div>
            </div>
        </div>
    </section>
                ...
                <ol class="process_container-stages">
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">Мы&nbsp;начали создание дизайн-проекта квартиры площадью 38м&sup2; с&nbsp;детального обсуждения образа жизни
                                и&nbsp;предпочтений заказчиков. Затем разработали концепцию, учитывающую их&nbsp;привычки: функциональная и&nbsp;уютная кухня-гостиная для встреч с&nbsp;друзьями и&nbsp;спальня с&nbsp;декоративной панелью. Также подобрали высококачественные материалы и&nbsp;мебель.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">Мы&nbsp;начали проект с&nbsp;тщательной подготовки и&nbsp;планирования. Провели несколько встреч с&nbsp;заказчиками, составили детальный план работ и&nbsp;бюджет, чтобы наши клиенты могли быть уверены в&nbsp;прозрачности
                    ...
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">В&nbsp;рамках демонтажных работ мы&nbsp;сносили старые перегородки и&nbsp;формировали проёмы для установки новых дверей скрытого монтажа, учитывая как технические требования, так и&nbsp;эстетический аспект.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                    ...
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">После завершения предчистовой подготовки мы&nbsp;оклеили стены обоями в&nbsp;сером цвете, на&nbsp;пол уложили ламинат на&nbsp;подложку, а&nbsp;потолок сделали натяжной с&nbsp;трековыми и&nbsp;дизайнерскими светильниками.
                                В&nbsp;совмещенном санузле мы&nbsp;уложили на&nbsp;стены и&nbsp;пол темную плитку среднего размера, залили душевой поддон, смонтировали стеклянные шторки, раковину с&nbsp;тумбой, зеркало, инсталляцию и&nbsp;сантехнику в&nbsp;чёрном цвете. Установили двери скрытого монтажа.</p>
                        </div>
                    </li>
                    <li class="process_stages-item">
                        ...
                        <div class="process_item-content">
                            ...
                            <p class="process_content-desk">После завершения всех отделочных работ на&nbsp;объекте, нашими специалистами была установлена кухня
                                и&nbsp;мебель под заказ. Также мы&nbsp;организовали профессиональный клининг!</p>
                        </div>
                    </li>
                </ol>
            </div>
        ...
        <div class="container">
            <div class="result_container">
                ...
                <div class="result_container-img">
                    <img src="../images/galaxy_result_desk-1.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-2.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-3.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-4.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-5.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-6.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-7.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-8.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-9.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-10.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-11.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-12.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-13.jpg" alt="" class="result_img">
                    <img src="../images/galaxy_result_desk-14.jpg" alt="" class="result_img">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="video_container">
                <video playsinline poster="">
                    <source src="videos/Rewgalaxy38.mp4" type="video/mp4">
        ...
        <div class="container">
            <div class="bed_container">
                ...
                <div class="bed_img-container">
                    <img src="../images/galaxy_bed1.jpg" alt="" class="bed_img bed_img1">
                    <img src="../images/galaxy_bed2.jpg" alt="" class="bed_img bed_img2">
                    <img src="../images/galaxy_bed3.jpg" alt="" class="bed_img bed_img3">
                    <img src="../images/galaxy_bed4.jpg" alt="" class="bed_img bed_img4">
                    <img src="../images/galaxy_bed5.jpg" alt="" class="bed_img bed_img5">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="kit_container">
                ...
                <div class="kit_container-img">
                    <img src="../images/galaxy_kit1.jpg" alt="" class="kit_img">
                    <img src="../images/galaxy_kit2.jpg" alt="" class="kit_img">
                    <img src="../images/galaxy_kit3.jpg" alt="" class="kit_img">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="san_container">
                ...
                <div class="san_img-container">
                    <img src="../images/galaxy_san1.jpg" alt="" class="san_img san_img1">
                    <img src="../images/galaxy_san2.jpg" alt="" class="san_img san_img2">
                    <img src="../images/galaxy_san3.jpg" alt="" class="san_img san_img3">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="smet_section">
        <div class="container light-grey-bg">
            <h2 class="title smet_title">Сэкономили 91 549₽<br>на чистовых и черновых материалах</h2>
