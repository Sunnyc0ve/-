        ...
        <div class="container">
            <div class="main_container">
                ...
                <div class="main_video-container">
                    <video src="videos/Zk-Black-River-38.mp4" class="main_video" autoplay muted loop aria-label="Видеопрезентация интерьера.">Ваш браузер не поддерживает видео.</video>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="video_container">
                <video playsinline poster="">
                    <source src="videos/Rewchernayarechka38.mp4" type="video/mp4">
